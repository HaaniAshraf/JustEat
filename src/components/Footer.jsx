  ...
  return (
    <div>
      <div className="bg-gray-200 flex justify-center items-center py-5 gap-2 sm:gap-8 px-5 sm:px-20">
        <div>
          <h2 className="text-gray-800 font-bold sm:text-xl md:text-2xl w-2/3">
            For better experience,download <br /> the JustEat app now
          </h2>
        </div>
        <div className="flex gap-5 w-1/3 justify-center">
          <div className="footer-app">
            <div className="">
              <img src={Gplay} alt="" className="footer-img" />
            </div>
          ...
          <div className="footer-app">
            ...
            <div className="hidden sm:block">
              Download from <br /> <span className="font-bold">App Store</span>
            </div>
          </div>
        </div>
      </div>
